...
namespace MyLifeJob.DAL.Migrations
{
    ...
    [Migration("20240226100533_CreateAdvertismentAbilityTables")]
    partial class CreateAdvertismentAbilityTables
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MyLifeJob.Core.Entity.AdvertismentAbility", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("AdvertismentAbilities");
                });
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("MyLifeJob.Core.Entity.AppUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("MyLifeJob.Core.Entity.AdvertismentAbility", b =>
                {
                    b.HasOne("MyLifeJob.Core.Entity.Ability", "Ability")
                        .WithMany("AdvertismentAbilities")
            ...
            modelBuilder.Entity("MyLifeJob.Core.Entity.EmailToken", b =>
                {
                    b.HasOne("MyLifeJob.Core.Entity.AppUser", "User")
                        .WithOne("EmailToken")
                        .HasForeignKey("MyLifeJob.Core.Entity.EmailToken", "UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
